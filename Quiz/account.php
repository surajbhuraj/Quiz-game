...
<div class="row">
<div class="col-lg-6">
<span class="logo">Suraj Skill tester</span></div>
...
<a href="#" data-toggle="modal" data-target="#developers" s style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">Organized by Suraj</a>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="font-family:'typo' "><span style="color:orange">Suraj Demo</span></h4>
      </div>
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/muki.jpg" width=100 height=100 alt="Ram" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="">Suraj Demo</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+977 9843775548</h4>
		<h4 style="font-family:'typo' ">surajbajracharya10@gmail.com</h4>
		<h4 style="font-family:'typo' ">St. xaviers college ,Nepal </h4></div></div>
		</p>
      </div>
